...
class CustomCSVLogger(BaseLogger, SupervisedPlugin):
    """CSV logger.
    ...
    def print_train_metrics(
        self, training_exp, epoch, train_acc, training_f1, val_acc, train_loss, val_loss
    ):
        print(
            training_exp,
            epoch,
            self._val_to_str(train_acc),
            self._val_to_str(training_f1),
    ...
    def print_eval_metrics(
        self, eval_exp, training_exp, eval_acc, eval_f1, eval_loss, forgetting
    ):
        print(
            eval_exp,
            training_exp,
            self._val_to_str(eval_acc),
            self._val_to_str(eval_f1),
    ...
    def after_training_epoch(
        ...
        **kwargs,
        ...
        train_acc, val_acc, train_loss, val_loss, train_f1 = 0, 0, 0, 0, 0
        for val in metric_values:
            if "train_stream" in val.name:
                ...
                elif val.name.startswith("F1_Epoch"):
                    train_f1 = val.value
    ...
    def after_eval_exp(
        ...
        **kwargs,
        ...
        acc, loss, forgetting, f1 = 0, 0, 0, 0
        ...
        for val in metric_values:
            if self.in_train_phase:  # validation within training
                ...
                elif val.name.startswith("F1_Exp"):
                    f1 = val.value
